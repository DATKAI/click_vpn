...
REGISTRY = {
    ...
    "selective_routing": {
        "title": "Селективная маршрутизация",
        "description": "Split tunnel: в VPN идут только выбранные сайты/сервисы "
                       "(обход блокировок без прогона всего трафика). Профили маршрутов "
                       "из списков CIDR/доменов, назначаются клиенту или тарифу.",
        "icon": "routes",
    },
    "site2site": {
        "title": "Site-to-Site (площадки)",
        "description": "Связь сетей филиалов через хаб. Топология звезда (hub-and-spoke). "
                       "Транспорт WireGuard, статическая маршрутизация. "
                       "Панель генерирует готовые конфиги для роутеров площадок.",
        "icon": "site2site",
    },
}
