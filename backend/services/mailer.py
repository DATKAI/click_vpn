...
def _instructions_html(kind: str, has_installer: bool, password: str | None,
    ...
    if kind == "openvpn" and (has_installer or has_link):
        ...
        <ol style="font-size:14px;color:#334155;line-height:1.8;padding-left:20px">
          ...
          <li>Дождитесь сообщения «Готово!» и нажмите «ОК».</li>
          <li>На рабочем столе появится ярлык <b>«OpenVPN GUI»</b> — запустите его. Внизу экрана, в <b>области уведомлений</b> (справа от часов, иногда под стрелкой ▲), появится значок OpenVPN — серый экран с замком.</li>
