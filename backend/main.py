...
from routers import auth, settings, servers, users, status, organizations, logs, system, audit, backup, stats, download, modules, billing, s2s, updates, routes as routes_router, components
